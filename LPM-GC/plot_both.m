function [FP,FN] = plot_both(I1, I2, X, Y, VFCIndex, CorrectIndex)
...
WhiteInterval = 255*ones(interval, size(I1,2), size(I1,3));
figure
A=cat(1, I1, WhiteInterval, I2);
imshow(A) ;
hold on ;
...
% line([X(TruePos,1)'; Y(TruePos,1)'+size(I1,2)+interval], [X(TruePos,2)' ;  Y(TruePos,2)'],'linewidth', 1.2, 'color', 'b') ;
% line([X(FalsePos,1)'; Y(FalsePos,1)'+size(I1,2)+interval], [X(FalsePos,2)' ;  Y(FalsePos,2)'],'linewidth', 1.2, 'color', 'r') ;
% line([X(FalseNeg,1)'; Y(FalseNeg,1)'+size(I1,2)+interval], [X(FalseNeg,2)' ;  Y(FalseNeg,2)'],'linewidth', 1.2, 'color', 'g') ;
line([X(TruePos,1)'; Y(TruePos,1)'], [X(TruePos,2)' ;  Y(TruePos,2)'+size(I1,1)+interval],'linewidth', 1.2, 'color', 'b') ;
line([X(FalsePos,1)'; Y(FalsePos,1)'], [X(FalsePos,2)' ;  Y(FalsePos,2)'+size(I1,1)+interval],'linewidth', 1.2, 'color', 'r') ;
line([X(FalseNeg,1)'; Y(FalseNeg,1)'], [X(FalseNeg,2)' ;  Y(FalseNeg,2)'+size(I1,1)+interval],'linewidth', 1.2, 'color', 'g') ;
...
quiver(X(TrueNeg, 1), siz(1)-X(TrueNeg, 2), (Y(TrueNeg, 1)-X(TrueNeg, 1)), (-Y(TrueNeg, 2)+X(TrueNeg, 2)), k, 'r'), hold on%%k
