...
\begin{algorithm}[H]
    ...
    \KwIn{A set of distinct points $P={p_1, p_2, \cdots , p_k}$}, and the weights $\{A_1, A_2, \cdots , A_k \}$; A convex domain $\Omega, \sum A_j = Vol(\Omega)$;
    
    \KwOut{The optimal transport map $T:\Omega \to P$}
