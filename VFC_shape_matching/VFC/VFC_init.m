...
%       and smoothnees of the field. Default value is 3.
%
...
%
%   fast: value 1 indicates using FastVFC. Default Value is 0.
%
...
if ~isfield(conf,'fast'), conf.fast = 0; end;
